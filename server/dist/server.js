...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "a11774f1c6d6bef437c8";
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.createPet = exports.getPetByID = exports.getPets = void 0;
var generateRandomID_1 = __webpack_require__(/*! ./utils/generateRandomID */ "./src/utils/generateRandomID.ts");
var collections = {
    pets: [
        {
            id: "pet_wqf0rv0im6",
...
exports.getPetByID = function (id) {
    return collections.pets.find(function (pet) { return pet.id === id; });
};
exports.createPet = function (pet) {
    var newPet = __assign(__assign({}, pet), { id: generateRandomID_1.generateRandomID("pet_") });
...
exports.default = {
    ...
    Mutation: {
        addPet: function (_parent, args) {
            return db_1.createPet(args.pet);
        },
    },
};
...
module.exports = __webpack_require__(/*! /Users/cheolee/repos/apollo-example/server/src/main.ts */"./src/main.ts");
